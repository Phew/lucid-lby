...
void hud_indicators::Indicators()
{
	...
	render::indicators.string(x + 10 + 6, m_height / 2 + 40, { 255, 255, 255, 255 }, "damage override", render::ALIGN_LEFT);
	render::indicators.string(x + 10 + 6, m_height / 2 + 50, { 255, 255, 255, 255 }, "doubletap", render::ALIGN_LEFT);
